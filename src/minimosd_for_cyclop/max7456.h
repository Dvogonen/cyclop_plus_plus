...
/**
    @class Max7456
    @max7456 device communicating through SPI port
 **/
class Max7456
{
  public:
    ...
    /**
        ...
        @param pinCS : arduino digital output pin connected to CS of max7456.
     **/
    Max7456(byte pinCS);
    ...
    /**
       ...
       @param blinkBase : the base time
       @param blinkDC : blink Duty cycle
     **/
     ...
     **/
    static byte* CARACT2ByteArray(const CARACT car, byte *array);
